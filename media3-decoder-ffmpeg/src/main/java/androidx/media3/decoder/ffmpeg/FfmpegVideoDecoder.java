...
/* package */ final class FfmpegVideoDecoder
   ...
   * @param format                 The {@link Format} of the video.
   ...
   * @param inputTime   Presentation time of the input data.
   ...
   * @param decodeOnly   Whether the frame is decode-only.
  ...
  // The following methods are present in the arm64-v8a prebuilt libffmpegJNI.so. They are declared
  // here to ensure the Java class name matches the native symbols exactly. Some of them may be
  // optional depending on the native build, but declaring them is harmless as long as they are not
  // called.
  ...
  @SuppressWarnings("unused")
  private native void ffmpegReleaseFrame(long context);
