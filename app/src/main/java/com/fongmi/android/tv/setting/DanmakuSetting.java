...
public class DanmakuSetting {
    ...
    private static final float DEFAULT_TRANSPARENCY = 0.2f;
    private static final int DEFAULT_STYLE_MODE = DanmakuConfig.STYLE_NONE;
    private static final int DEFAULT_COLOR_MODE = DanmakuConfig.COLOR_MODE_DEFAULT;
    private static final int DEFAULT_MAX_ON_SCREEN = 80;
    private static final int DEFAULT_MAX_SCROLL_LINES = 3;
    ...
    public static float getTransparency() {
        return Prefers.getFloat("danmaku_transparency", DEFAULT_TRANSPARENCY);
    }
    ...
    public static int getStyleMode() {
        return Prefers.getInt("danmaku_style_mode", DEFAULT_STYLE_MODE);
    }
    ...
    public static int getColorMode() {
        return Prefers.getInt("danmaku_color_mode", DEFAULT_COLOR_MODE);
    }
    ...
    public static int getMaxOnScreen() {
        return Prefers.getInt("danmaku_max_on_screen", DEFAULT_MAX_ON_SCREEN);
    }
    ...
    public static int getMaxScrollLines() {
        return Prefers.getInt("danmaku_max_scroll_lines", DEFAULT_MAX_SCROLL_LINES);
    }
    ...
    public static float getLineSpacing() {
        return Prefers.getFloat("danmaku_line_spacing", DEFAULT_LINE_SPACING);
    }
    ...
    public static void resetAppearance() {
        ...
        putTransparency(DEFAULT_TRANSPARENCY);
        putTextBold(config.textBold);
        putStyleMode(DEFAULT_STYLE_MODE);
        ...
        putColorMode(DEFAULT_COLOR_MODE);
    }
    ...
    public static void resetDensity() {
        DanmakuConfig config = DanmakuConfig.DEFAULT;
        putMaxOnScreen(DEFAULT_MAX_ON_SCREEN);
        putScrollAreaRatio(config.scrollAreaRatio);
        putScrollGapRatio(config.scrollGapRatio);
        putLineSpacing(DEFAULT_LINE_SPACING);
        putMaxScrollLines(DEFAULT_MAX_SCROLL_LINES);
