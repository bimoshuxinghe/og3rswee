...
public class Backup {
    ...
    public static Backup create() {
        ...
        Map<String, Object> prefers = new HashMap<>(Prefers.getPrefers().getAll());
        prefers.remove("sync_url");
        prefers.remove("sync_user");
        prefers.remove("sync_pass");
        prefers.remove("hot");
        backup.setPrefers(prefers);
