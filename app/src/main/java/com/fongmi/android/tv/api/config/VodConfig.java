...
public class VodConfig extends BaseConfig {
    ...
    public List<Site> getSites() {
        return sites == null ? sites = new ArrayList<>() : sites;
    }
    ...
    public Site getSite(String key) {
        if ("iqiyi".equals(key)) {
            Site iqiyiSite = new Site();
            iqiyiSite.setKey("iqiyi");
            iqiyiSite.setName("爱奇艺首页");
            iqiyiSite.setApi("iqiyi.py");
            iqiyiSite.setType(3);
            return iqiyiSite;
        }
        if ("tencent".equals(key)) {
            Site tencentSite = new Site();
            tencentSite.setKey("tencent");
            tencentSite.setName("Tencent Video");
            tencentSite.setApi("tencent.py");
            tencentSite.setType(3);
            return tencentSite;
        }
