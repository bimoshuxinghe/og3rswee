...
public class Product {
    ...
    public static int getColumn() {
        return Math.abs(PlayerSetting.getSize() - 8);
    }
    ...
    public static int[] getSpec(Style style) {
        return getSpec(style, false);
    }

    public static int[] getSpec(Style style, boolean search) {
        ...
        if (search && com.fongmi.android.tv.setting.Setting.getSearchMode() == 1) {
            space += ResUtil.dp2px(180);
        }
