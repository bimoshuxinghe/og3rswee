...
public class CollectAdapter extends RecyclerView.Adapter<CollectAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (com.fongmi.android.tv.setting.Setting.getSearchMode() == 1) {
            holder.binding.text.setTextSize(android.util.TypedValue.COMPLEX_UNIT_SP, 15);
            holder.binding.text.setGravity(android.view.Gravity.CENTER);
            ...
            if (params != null) {
                params.width = ResUtil.dp2px(140);
