...
import com.fongmi.android.tv.ui.fragment.SettingAutoSiteFragment;
...
public class HomeActivity extends BaseActivity implements NavigationBarView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        // 启动画面改为主题 windowBackground 全屏星落图，不再使用 androidx SplashScreen 图标页
