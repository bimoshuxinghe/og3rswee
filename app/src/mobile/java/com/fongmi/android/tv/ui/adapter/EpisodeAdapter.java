...
import com.fongmi.android.tv.ui.holder.EpisodeListHolder;
...
public class EpisodeAdapter extends RecyclerView.Adapter<BaseEpisodeHolder> {
    ...
    public BaseEpisodeHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == ViewType.HORI) {
            ...
            return new EpisodeListHolder(AdapterEpisodeListBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false), listener);
        } else {
