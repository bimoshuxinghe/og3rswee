...
public class EpgDataAdapter extends RecyclerView.Adapter<EpgDataAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        boolean land = com.fongmi.android.tv.utils.ResUtil.isLand(context);
        int textColorRes = land ? com.fongmi.android.tv.R.color.selector_text : com.fongmi.android.tv.R.color.selector_text_portrait;
        holder.binding.time.setTextColor(androidx.appcompat.content.res.AppCompatResources.getColorStateList(context, textColorRes));
        holder.binding.title.setTextColor(androidx.appcompat.content.res.AppCompatResources.getColorStateList(context, textColorRes));
    }
